...
def extract_features(image):
    ...
    features = np.hstack([contrast.ravel(), dissimilarity.ravel(), homogeneity.ravel(), energy.ravel(), correlation.ravel()])
...
# def visualize_features_with_pca(features):
...
#     plt.title('Features Visualization with PCA')
#     plt.xlabel('First Principal Component')
#     plt.ylabel('Second Principal Component')
#     plt.show()

# visualize_features_with_pca(features) 
